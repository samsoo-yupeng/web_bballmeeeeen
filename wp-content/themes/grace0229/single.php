...
function vponCallBackMethod(adStatus) {
  if (adStatus != 0 && $('.app-hidden-ads').length == 0) {
		 ...
		 var cfad6286 = document.getElementById('clickforceads_6286');
        var ins6286 = document.createElement('ins');
        ins6286.setAttribute('class','clickforceads');
        ins6286.setAttribute('style','display:inline-block;width:320px;height:480px;left:0;top:0;');
        ins6286.setAttribute('data-ad-zone','6286');
        var script6286 = document.createElement('script');
        script6286.setAttribute('async','true');
        script6286.src='//cdn.doublemax.net/js/init.js';
        cfad6286.appendChild(ins6286);
        cfad6286.appendChild(script6286);
...
<script src="//cdn.doublemax.net/image/creative/20190613/basketball_like.js"></script>
